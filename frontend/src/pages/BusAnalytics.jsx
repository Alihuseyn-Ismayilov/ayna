...
const BusAnalytics = () => {
  ...
  const loadAnalytics = async () => {
    try {
      ...
      const response = await api.get(`/api/bus/analytics?${params}`);
  ...
  const loadTableData = async () => {
    try {
      ...
      const response = await api.get(`/api/bus/registrations?limit=10000&${params}`);
        ...
        <div className="filters-grid">
          ...
          <div className="filter-group">
            ...
            <div className="hour-inputs">
              <input 
                ...
                onChange={(e) => handleFilterChange('hourStart', e.target.value)}
              />
              <span>to</span>
              <input 
                type="number" 
                ...
                onChange={(e) => handleFilterChange('hourEnd', e.target.value)}
              />
            </div>
          </div>
          ...
          <div className="filter-group">
            ...
            >
              ...
              {dropdowns.companies.map(company => (
